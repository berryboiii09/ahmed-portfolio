    ...
    return (
        <div className="min-h-screen flex justify-center items-center px-6 pt-40 pb-20">
            <div className="max-w-6xl w-full text-center">
                <h2 className="text-4xl font-bold pb-6">All Projects</h2>
                ...
                <div className="flex justify-center gap-4 mt-10">
                    <button
                        ...
                        disabled={page === 1}
                        className="px-4 py-2 border bg-violet-600 text-white enabled:hover:bg-fuchsia-600 border-violet-900 enabled:hover:border-fuchsia-900 transition-colors duration-300 enabled:cursor-pointer rounded-full disabled:opacity-30"
                    >
                        Prev
                    </button>
