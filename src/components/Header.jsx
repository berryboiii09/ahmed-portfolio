        ...
        <div className="flex justify-center items-center">
            <div
                ...
                <div
                    ...
                    `}
                >
                    <li className="list-none cursor-pointer hover:text-blue-500" onClick={() => handleNavigation("about")}>About</li>
                    <li className="list-none cursor-pointer hover:text-blue-500" onClick={() => handleNavigation("skills")}>Skills</li>
                    <li className="list-none cursor-pointer hover:text-blue-500" onClick={() => handleNavigation("projects")}>Projects</li>
                    <li className="list-none cursor-pointer hover:text-blue-500" onClick={() => handleNavigation("contact")}>Contact</li>
                </div>
            </div>
        </div>
    );
