...
export default function ProjectDetails() {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-center items-center px-6 py-30 dark:bg-slate-950 transition-colors duration-300">
            <div className="max-w-3xl w-full">
                <div className="pb-4 flex justify-center items-center">
                    <Link to="/" className="text-blue-500 underline hover:text-blue-700">← Back to home</Link>
                </div>
                <img src={project.imageUrl} alt={project.title} className="w-full mb-4 rounded-xl border border-slate-900 dark:border-slate-300"/>
                ...
                <p className="text-2xl font-bold mb-6 pt-2 dark:text-white transition-colors duration-300">Project Features</p>
                ...
                <p className="text-2xl font-bold mb-6 pt-2 dark:text-white transition-colors duration-300">Tech Stack</p>
